...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--netD', type=str, default='basic', choices=['basic', 'n_layers', 'global','ins_global','pixel', 'patch', 'tilestylegan2', 'stylegan2'], help='specify discriminator architecture. The basic model is a 70x70 PatchGAN. n_layers allows you to specify the layers in the discriminator')
        parser.add_argument('--netG', type=str, default='adain_resnet_9blocks', choices=['adain_resnet_9blocks','resnet_9blocks', 'resnet_6blocks', 'unet_256', 'unet_128', 'stylegan2', 'smallstylegan2', 'resnet_cat'], help='specify generator architecture')
    ...
    def print_options(self, opt):
        ...
        util.prepare_sub_directories(opt.run_dir, opt)
